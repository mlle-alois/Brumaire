    ...
    return (
        <div>
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>
                        Vous pouvez <b>réserver un essai</b> sur notre site internet. Un Ambassadeur se déplacera dans
                        un de
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>
                        Nos délais de livraison varient d'une semaine à deux mois. Ils dépendent de votre adresse de
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>
                        Notre scooter est en vente à partir de 3190€ TTC (entre 1690 € et 2590€ après subventions). Pour
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>
                        Brumaire Service dispose d'un réseau dense de garages en Île-de-France. Une question sur votre
                        scooter ? Contactez l'<b><a href={"https://www.brumaire.co/contact"}
                                                    target={"_blank"}>Assistance</a></b> et nous vous répondons dans les
                        24h.
                    </Typography>
                </AccordionDetails>
            </Accordion>
